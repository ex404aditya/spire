...
var transformFunctions = {
  ...
  flexDirection(value) {
    var _a;
    const { space: space2, divide: divide22 } = (_a = flexDirectionTemplate[value]) != null ? _a : {};
...
var getColor = (theme, color2, fallback) => {
  const hex = dlv_es_default(theme, `colors.${color2}`, color2);
  try {
    toHex(hex);
    return hex;
  } catch {
...
var getColorVar = (theme, color2, fallback) => {
  var _a;
  return (_a = getCSSVar(theme, "colors", color2)) != null ? _a : fallback;
};
...
//# sourceMappingURL=chunk-X5VBIM2S.js.map
